          ...
          <div className="row">
            <div className="col-lg-6 d-flex align-items-center">
              <div className="software_banner_content">
                <h2 className="f_500 f_size_50 w_color wow fadeInLeft" data-wow-delay="0.2s">
                  We deliver the <span className="f_700">Software</span> You need, no more no less
                </h2>
                <p className="w_color f_size_18 l_height30 mt_30 wow fadeInLeft" data-wow-delay="0.4s">
