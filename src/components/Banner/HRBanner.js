  ...
  return (
    <section className="startup_banner_area_three">
          ...
          <div className="col-lg-6">
            <Reveal bottom cascade duration={1100}>
              <div className="startup_content_three">
                <h2>
                  <span>Build powerful apps</span> using the fastest API for messaging
                </h2>
                <p>Walking on water and developing software from a specification are easy.</p>
                <a href=".#" className="btn_six slider_btn">
                  开始使用
                </a>
                <a href="https://www.youtube.com/watch?v=sU3FkzUKHXU" className="popup-youtube btn_six slider_btn">
      ...
      <div className="stratup_app_screen">
        ...
        <Reveal effect="slideInnew">
          <img className="laptop" src={require('../../img/new/0111.png')} alt="" />
        </Reveal>
      </div>
    </section>
  )
