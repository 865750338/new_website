        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="portfolio_details_info pr_50">
              <h5 className="f_700 f_p f_size_20 t_color3 mb-30">全新项目</h5>
              <p className="f_400 f_size_15 mb-0">
                Why I say old chap that is spiffing tickety-boo amongst, brolly bugger say William in my flat Elizabeth
                tosser. Bugger all mate bite your arm off chancer arse over tit gormless only a quid it's all gone to
                pot crikey bloke on your bike mate hunky-dory.
              </p>
