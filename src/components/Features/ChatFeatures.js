...
class ChatFeatures extends Component {
  render() {
    let { img1, img2, img3, rowClass, col1, col2, url, titleSmall, titlebig, p, icon, pClass } = this.props
    return (
          ...
          <div className={`row align-items-center ${rowClass}`}>
            <div className={col1}>
              <div className="chat_features_img chat_features_img_one">
                <img className="p_absoulte dot_bg" src={require('../../img/home-chat/' + img1)} alt="" />
                <img
                  className="chat_one"
